...
class eventController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RestDumbledarApiBundle:event')->findAll();
     ...
     * @Method("POST")
     * @Template("RestDumbledarApiBundle:event:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RestDumbledarApiBundle:event:edit.html.twig")
     */
